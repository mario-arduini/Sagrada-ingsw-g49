...
class FullSetTest {
    ...
    private void fillMosaic2(Window window) {
        ...
        } catch (ConstraintViolatedException | InvalidDiceValueException | DiceAlreadyHereException | BadAdjacentDiceException | NoAdjacentDiceException | FirstDiceMisplacedException e) {
            e.printStackTrace();
        }
    }
