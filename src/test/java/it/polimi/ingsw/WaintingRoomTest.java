...
public class WaintingRoomTest {

    @Test
    void waintingRoomTest(){

        WaitingRoom waitingRoom = WaitingRoom.getWaitingRoom();
        assertTrue(waitingRoom.getPlayers() == null);
        ...
        try {
            ...
            assertEquals(player1, waitingRoom.getPlayers().get(1));
        }
        ...
        try {
            ...
            assertEquals(player1, waitingRoom.getPlayers().get(1));
            assertEquals(player2, waitingRoom.getPlayers().get(2));
