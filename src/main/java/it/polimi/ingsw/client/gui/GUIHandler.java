...
import it.polimi.ingsw.client.model.GameSnapshot;
import it.polimi.ingsw.client.model.PlayerSnapshot;
import it.polimi.ingsw.client.model.ToolCard;
    ...
    public void printMenu(GameSnapshot gameSnapshot) {
        if(gameStarted){
            Platform.runLater(()->{
                ...
                playerGrid.setPlacingDice(false);
