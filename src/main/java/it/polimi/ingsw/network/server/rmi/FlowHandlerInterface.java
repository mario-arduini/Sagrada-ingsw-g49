...
public interface FlowHandlerInterface extends java.io.Serializable{
    ...
    void chooseSchema(Integer schemaNumber) throws WindowAlreadySetException;
    void placeDice(int row, int column, Dice dice) throws NotYourTurnException, NoAdjacentDiceException, DiceAlreadyExtractedException, BadAdjacentDiceException, FirstDiceMisplacedException, ConstraintViolatedException, DiceNotInDraftPoolException, NoSameColorDicesException, GameNotStartedException;
